...
var DataTableFn = function(){
  ...
  configDT.fnServerParams = function ( aoData ) {
    aoData.push( { "name": "filter-id_product", "value": $('#id_productFormSelect<?= $wgetId ?>').val() } );
  ...
  configDT.aoColumns = [
    ...
    { "sTitle": "<?= $this->lang->line("Orden") ?>", "sWidth": "40px", "mData": "num", "sType": "string"},
    { "sTitle": "<?= $this->lang->line("Producto") ?>", "mData": "product", "sType": "string"},
    ...
    }},    { "sWidth": "60px", "sClass": "text-align-center widget-filemanager", "sTitle": "<?= $this->lang->line("File") ?>", "mData": "fm1file", "sType":"html", "mRender" : function( data, type, full ){ 
      var type = 0;
