...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Costo de envío") ?>", "mData": "shipping", "sType": "string"},
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Estado") ?>", "mData": "active", "sType": "string"},
